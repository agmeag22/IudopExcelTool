...
<body>
    <div class="cst-content cst-flex-wrap unselectable">
        <div class="cst-card cst-flex-center cst-flex-v unselectable">
            ...
            <form action="{{url('/informe/import')}}" method="POST" enctype="multipart/form-data" class="cst-flex-v ">
                @csrf
        ...
        <div class="cst-card cst-flex-center cst-flex-v unselectable">
            ...
            <form action="{{url('/indice/import')}}" method="POST" enctype="multipart/form-data" class="cst-flex-v">
                @csrf
                <div class="form-group mb-4" style="max-width: 500px; margin: 0 auto;">
                    <div class="custom-file text-left">
                        <input type="file" name="file" class="custom-file-input" id="customFile">
